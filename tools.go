...
// of this type will have access to all the methods with the receiver
// *Tools
type Tools struct {
	MaxFileSize      int
...
// using randomStringSource as the source for the character
	...
	for _, fHeaders := range r.MultipartForm.File {
		for _, hdr := range fHeaders {
			uploadedFiles, err = func(uploadedFiles []*UploadedFile) ([]*UploadedFile, error) {
				...
				allowed := false // assume it's not permitted
